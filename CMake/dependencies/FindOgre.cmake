...
set (OGRE_HOME $ENV{OGRE_HOME} CACHE PATH "Ogre Home path")
set (OGRE_SDK $ENV{OGRE_SDK} CACHE PATH "Ogre SDK path")
set (OGRE_SOURCE $ENV{OGRE_SOURCE} CACHE PATH "Ogre Source path")
set (OGRE_BUILD $ENV{OGRE_BUILD} CACHE PATH "Ogre Build path")
set (OGRE_STATIC FALSE CACHE BOOL "Use static Ogre Libraries?")
...
mark_as_advanced(OGRE_CONFIG_INCLUDE_DIR OGRE_PLUGIN_DIR_REL OGRE_PLUGIN_DIR_DBG)
